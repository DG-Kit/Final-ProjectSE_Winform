...
namespace DTO
{
    public class DTO_ExportReceipt
    {
        ...
        public DTO_ExportReceipt(int ReceiptID, int TotalPrice, string DateCreated, int AccountantID)
        {
        ...
        public DTO_ExportReceipt(int AccountantID)
        {
            this.AccountantID = AccountantID;
        }
    }
